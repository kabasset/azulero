...
- New, SAS-based data provider for Internal Data Releases (default
  provider).
...
- [Euclid members] Find index of tiles containing given objects or
  coordinates.
...
- Select the region to be rendered with a rudimentary graphical
  interface.
